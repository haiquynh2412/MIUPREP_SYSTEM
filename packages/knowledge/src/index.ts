...
export type DomainKind = "mathematics" | "english_core" | "physics" | "cross_domain" | string;
...
export function createSeedKnowledgeGraph(): KnowledgeGraph {
  const graph: KnowledgeGraph = {
    ...
    domains: [
      ...
      { id: "physics", name: "Physics", kind: "physics", status: "active" },
    ],
    programs: [
      ...
      { id: "vn_physics_6_7", name: "VN KHTN Physics 6-7", kind: "curriculum", domainIds: ["physics"], level: "lower_secondary_foundation", status: "active" },
      { id: "vn_physics_8_9", name: "VN KHTN Physics 8-9", kind: "curriculum", domainIds: ["physics"], level: "lower_secondary", status: "active" },
      { id: "vn_physics_10_12", name: "VN Physics 10-12", kind: "curriculum", domainIds: ["physics"], level: "upper_secondary", status: "draft" },
    ],
    concepts: [
      ...
      // Physics Grade 6 concepts
      { id: "phys.measurement", domainId: "physics", name: "Measurement and Units", gradeBand: "6", status: "active" },
      { id: "phys.mass_density", domainId: "physics", name: "Mass and Density", gradeBand: "6", status: "active" },
      { id: "phys.force_basics", domainId: "physics", name: "Force Basics", gradeBand: "6", status: "active" },
      { id: "phys.motion_basics", domainId: "physics", name: "Motion Basics", gradeBand: "6", status: "active" },
      { id: "phys.energy_basics", domainId: "physics", name: "Energy Basics", gradeBand: "6", status: "active" },
      { id: "phys.light_basics", domainId: "physics", name: "Light Basics", gradeBand: "6", status: "active" },
      { id: "phys.sound_basics", domainId: "physics", name: "Sound Basics", gradeBand: "6", status: "active" },
      // Physics Grade 7 concepts
      { id: "phys.speed_graph", domainId: "physics", name: "Speed and Motion Graphs", gradeBand: "7", status: "active" },
      { id: "phys.reflection_refraction", domainId: "physics", name: "Reflection and Refraction", gradeBand: "7", status: "active" },
      { id: "phys.sound_wave", domainId: "physics", name: "Sound Waves", gradeBand: "7", status: "active" },
      { id: "phys.magnetic_field_basics", domainId: "physics", name: "Magnetic Field Basics", gradeBand: "7", status: "active" },
      { id: "phys.earth_solar_system", domainId: "physics", name: "Earth and Solar System", gradeBand: "7", status: "active" },
      // Physics Grade 8 concepts
      { id: "phys.pressure", domainId: "physics", name: "Pressure", gradeBand: "8", status: "active" },
      { id: "phys.liquid_pressure", domainId: "physics", name: "Liquid and Atmospheric Pressure", gradeBand: "8", status: "active" },
      { id: "phys.buoyancy", domainId: "physics", name: "Buoyancy (Archimedes)", gradeBand: "8", status: "active" },
      { id: "phys.moment_of_force", domainId: "physics", name: "Moment of Force", gradeBand: "8", status: "active" },
      { id: "phys.kinetic_energy", domainId: "physics", name: "Kinetic Energy", gradeBand: "8", status: "active" },
      { id: "phys.potential_energy", domainId: "physics", name: "Potential Energy", gradeBand: "8", status: "active" },
      { id: "phys.energy_conservation", domainId: "physics", name: "Energy Conservation", gradeBand: "8", status: "active" },
      { id: "phys.heat_transfer", domainId: "physics", name: "Heat Transfer", gradeBand: "8", status: "active" },
      // Physics Grade 9 concepts
      { id: "phys.resistance_ohm", domainId: "physics", name: "Resistance and Ohm's Law", gradeBand: "9", status: "active" },
      { id: "phys.electric_circuit", domainId: "physics", name: "Electric Circuits", gradeBand: "9", status: "active" },
      { id: "phys.electric_power", domainId: "physics", name: "Electric Power", gradeBand: "9", status: "active" },
      { id: "phys.magnetic_force", domainId: "physics", name: "Magnetic Force and EM Induction", gradeBand: "9", status: "active" },
      { id: "phys.light_spectrum", domainId: "physics", name: "Light Spectrum (IR, UV)", gradeBand: "9", status: "active" },
      { id: "phys.nuclear_energy_intro", domainId: "physics", name: "Nuclear Energy Introduction", gradeBand: "9", status: "active" },
    ],
    skills: [
      ...
      // Physics skills
      { id: "phys.measure_with_tool", domainId: "physics", name: "Measure with appropriate tools", conceptIds: ["phys.measurement"], status: "active" },
      { id: "phys.estimate_measurement", domainId: "physics", name: "Estimate measurements", conceptIds: ["phys.measurement"], status: "active" },
      { id: "phys.calculate_density", domainId: "physics", name: "Calculate density", conceptIds: ["phys.mass_density", "phys.measurement"], status: "active" },
      { id: "phys.identify_force_effect", domainId: "physics", name: "Identify force effects", conceptIds: ["phys.force_basics"], status: "active" },
      { id: "phys.draw_force_diagram", domainId: "physics", name: "Draw force diagrams", conceptIds: ["phys.force_basics"], status: "active" },
      { id: "phys.describe_motion", domainId: "physics", name: "Describe motion types", conceptIds: ["phys.motion_basics"], status: "active" },
      { id: "phys.identify_energy_form", domainId: "physics", name: "Identify energy forms", conceptIds: ["phys.energy_basics"], status: "active" },
      { id: "phys.explain_light_phenomenon", domainId: "physics", name: "Explain light phenomena", conceptIds: ["phys.light_basics"], status: "active" },
      { id: "phys.explain_sound_phenomenon", domainId: "physics", name: "Explain sound phenomena", conceptIds: ["phys.sound_basics"], status: "active" },
      { id: "phys.calculate_speed", domainId: "physics", name: "Calculate speed from distance and time", conceptIds: ["phys.speed_graph", "phys.motion_basics"], status: "active" },
      { id: "phys.read_motion_graph", domainId: "physics", name: "Read and interpret motion graphs", conceptIds: ["phys.speed_graph"], status: "active" },
      { id: "phys.explain_reflection", domainId: "physics", name: "Explain reflection and refraction", conceptIds: ["phys.reflection_refraction", "phys.light_basics"], status: "active" },
      { id: "phys.analyze_sound_wave", domainId: "physics", name: "Analyze sound wave properties", conceptIds: ["phys.sound_wave", "phys.sound_basics"], status: "active" },
      { id: "phys.use_magnetic_compass", domainId: "physics", name: "Use magnetic compass and field lines", conceptIds: ["phys.magnetic_field_basics"], status: "active" },
      { id: "phys.describe_solar_system", domainId: "physics", name: "Describe Earth in solar system", conceptIds: ["phys.earth_solar_system"], status: "active" },
      { id: "phys.calculate_pressure", domainId: "physics", name: "Calculate pressure", conceptIds: ["phys.pressure"], status: "active" },
      { id: "phys.apply_liquid_pressure", domainId: "physics", name: "Apply liquid and atmospheric pressure", conceptIds: ["phys.liquid_pressure", "phys.pressure"], status: "active" },
      { id: "phys.apply_archimedes", domainId: "physics", name: "Apply Archimedes principle", conceptIds: ["phys.buoyancy", "phys.liquid_pressure"], status: "active" },
      { id: "phys.calculate_moment", domainId: "physics", name: "Calculate moment of force", conceptIds: ["phys.moment_of_force", "phys.force_basics"], status: "active" },
      { id: "phys.apply_energy_conservation", domainId: "physics", name: "Apply energy conservation", conceptIds: ["phys.energy_conservation", "phys.kinetic_energy", "phys.potential_energy"], status: "active" },
      { id: "phys.explain_heat_transfer", domainId: "physics", name: "Explain heat transfer methods", conceptIds: ["phys.heat_transfer"], status: "active" },
      { id: "phys.solve_ohm_law", domainId: "physics", name: "Solve Ohm's law problems", conceptIds: ["phys.resistance_ohm", "phys.electric_circuit"], status: "active" },
      { id: "phys.analyze_circuit", domainId: "physics", name: "Analyze electric circuits", conceptIds: ["phys.electric_circuit", "phys.resistance_ohm"], status: "active" },
      { id: "phys.calculate_electric_power", domainId: "physics", name: "Calculate electric power and energy", conceptIds: ["phys.electric_power", "phys.electric_circuit"], status: "active" },
      { id: "phys.explain_em_induction", domainId: "physics", name: "Explain electromagnetic induction", conceptIds: ["phys.magnetic_force", "phys.magnetic_field_basics"], status: "active" },
      { id: "phys.explain_light_spectrum", domainId: "physics", name: "Explain light spectrum", conceptIds: ["phys.light_spectrum", "phys.light_basics"], status: "active" },
      { id: "phys.describe_nuclear_energy", domainId: "physics", name: "Describe nuclear energy basics", conceptIds: ["phys.nuclear_energy_intro", "phys.energy_basics"], status: "active" },
    ],
    objectives: [
      {
      ...
      // Physics objectives
      {
        id: "obj.phys.grade6.foundation",
        domainId: "physics",
        name: "Grade 6 physics foundation",
        programIds: ["vn_physics_6_7"],
        conceptIds: ["phys.measurement", "phys.mass_density", "phys.force_basics", "phys.motion_basics", "phys.energy_basics", "phys.light_basics", "phys.sound_basics"],
        skillIds: ["phys.measure_with_tool", "phys.estimate_measurement", "phys.calculate_density", "phys.identify_force_effect", "phys.draw_force_diagram", "phys.describe_motion", "phys.identify_energy_form", "phys.explain_light_phenomenon", "phys.explain_sound_phenomenon"],
        status: "active",
      },
      {
        id: "obj.phys.grade7.foundation",
        domainId: "physics",
        name: "Grade 7 physics foundation",
        programIds: ["vn_physics_6_7"],
        conceptIds: ["phys.speed_graph", "phys.reflection_refraction", "phys.sound_wave", "phys.magnetic_field_basics", "phys.earth_solar_system"],
        skillIds: ["phys.calculate_speed", "phys.read_motion_graph", "phys.explain_reflection", "phys.analyze_sound_wave", "phys.use_magnetic_compass", "phys.describe_solar_system"],
        status: "active",
      },
      {
        id: "obj.phys.grade8.mechanics_energy",
        domainId: "physics",
        name: "Grade 8 mechanics and energy",
        programIds: ["vn_physics_8_9"],
        conceptIds: ["phys.pressure", "phys.liquid_pressure", "phys.buoyancy", "phys.moment_of_force", "phys.kinetic_energy", "phys.potential_energy", "phys.energy_conservation", "phys.heat_transfer"],
        skillIds: ["phys.calculate_pressure", "phys.apply_liquid_pressure", "phys.apply_archimedes", "phys.calculate_moment", "phys.apply_energy_conservation", "phys.explain_heat_transfer"],
        status: "active",
      },
      {
        id: "obj.phys.grade9.electricity_em",
        domainId: "physics",
        name: "Grade 9 electricity and electromagnetism",
        programIds: ["vn_physics_8_9"],
        conceptIds: ["phys.resistance_ohm", "phys.electric_circuit", "phys.electric_power", "phys.magnetic_force", "phys.light_spectrum", "phys.nuclear_energy_intro"],
        skillIds: ["phys.solve_ohm_law", "phys.analyze_circuit", "phys.calculate_electric_power", "phys.explain_em_induction", "phys.explain_light_spectrum", "phys.describe_nuclear_energy"],
        status: "active",
      },
    ],
    misconceptions: [
      ...
      {
        id: "mis.phys.heavier_falls_faster",
        domainId: "physics",
        name: "Heavier objects fall faster",
        kind: "conceptual",
        conceptIds: ["phys.force_basics", "phys.motion_basics"],
        skillIds: ["phys.draw_force_diagram", "phys.describe_motion"],
        status: "active",
      },
      {
        id: "mis.phys.force_needed_for_motion",
        domainId: "physics",
        name: "Force is needed to maintain motion",
        kind: "conceptual",
        conceptIds: ["phys.force_basics", "phys.motion_basics"],
        skillIds: ["phys.identify_force_effect"],
        status: "active",
      },
      {
        id: "mis.phys.current_consumed",
        domainId: "physics",
        name: "Current is consumed in a circuit",
        kind: "conceptual",
        conceptIds: ["phys.electric_circuit", "phys.resistance_ohm"],
        skillIds: ["phys.analyze_circuit"],
        status: "active",
      },
      {
        id: "mis.phys.heat_vs_temperature",
        domainId: "physics",
        name: "Confusing heat and temperature",
        kind: "conceptual",
        conceptIds: ["phys.heat_transfer", "phys.energy_basics"],
        skillIds: ["phys.explain_heat_transfer"],
        status: "active",
      },
      {
        id: "mis.phys.pressure_force_confusion",
        domainId: "physics",
        name: "Confusing pressure and force",
        kind: "conceptual",
        conceptIds: ["phys.pressure", "phys.force_basics"],
        skillIds: ["phys.calculate_pressure"],
        status: "active",
      },
      {
        id: "mis.phys.unit_conversion_error",
        domainId: "physics",
        name: "Unit conversion errors",
        kind: "calculation",
        conceptIds: ["phys.measurement"],
        skillIds: ["phys.measure_with_tool", "phys.estimate_measurement"],
        status: "active",
      },
      {
        id: "mis.phys.light_travels_only_straight",
        domainId: "physics",
        name: "Light can only travel in straight lines",
        kind: "conceptual",
        conceptIds: ["phys.light_basics", "phys.reflection_refraction"],
        skillIds: ["phys.explain_light_phenomenon", "phys.explain_reflection"],
        status: "active",
      },
      {
        id: "mis.phys.sound_in_vacuum",
        domainId: "physics",
        name: "Sound can travel through vacuum",
        kind: "conceptual",
        conceptIds: ["phys.sound_basics", "phys.sound_wave"],
        skillIds: ["phys.explain_sound_phenomenon"],
        status: "active",
      },
      {
        id: "mis.phys.energy_disappears",
        domainId: "physics",
        name: "Energy disappears or is created",
        kind: "conceptual",
        conceptIds: ["phys.energy_basics", "phys.energy_conservation"],
        skillIds: ["phys.identify_energy_form", "phys.apply_energy_conservation"],
        status: "active",
      },
      {
        id: "mis.phys.density_vs_weight",
        domainId: "physics",
        name: "Confusing density with weight",
        kind: "conceptual",
        conceptIds: ["phys.mass_density", "phys.force_basics"],
        skillIds: ["phys.calculate_density"],
        status: "active",
      },
      {
        id: "mis.phys.speed_velocity_confusion",
        domainId: "physics",
        name: "Confusing speed with velocity",
        kind: "conceptual",
        conceptIds: ["phys.motion_basics", "phys.speed_graph"],
        skillIds: ["phys.calculate_speed", "phys.describe_motion"],
        status: "active",
      },
      {
        id: "mis.phys.buoyancy_depends_depth",
        domainId: "physics",
        name: "Buoyancy force depends on depth",
        kind: "conceptual",
        conceptIds: ["phys.buoyancy", "phys.liquid_pressure"],
        skillIds: ["phys.apply_archimedes"],
        status: "active",
      },
    ],
    lessonTemplates: [
    ...
    edges: [
      ...
      // Physics edges - prerequisite and supports
      { id: "edge.phys.measurement_to_mass_density", from: "phys.measurement", to: "phys.mass_density", type: "prerequisite", weight: 0.8 },
      { id: "edge.phys.measurement_to_speed", from: "phys.measurement", to: "phys.speed_graph", type: "prerequisite", weight: 0.7 },
      { id: "edge.phys.force_to_motion", from: "phys.force_basics", to: "phys.motion_basics", type: "supports", weight: 0.9 },
      { id: "edge.phys.motion_to_speed_graph", from: "phys.motion_basics", to: "phys.speed_graph", type: "prerequisite", weight: 0.8 },
      { id: "edge.phys.force_to_pressure", from: "phys.force_basics", to: "phys.pressure", type: "prerequisite", weight: 0.8 },
      { id: "edge.phys.pressure_to_liquid", from: "phys.pressure", to: "phys.liquid_pressure", type: "prerequisite", weight: 0.9 },
      { id: "edge.phys.liquid_to_buoyancy", from: "phys.liquid_pressure", to: "phys.buoyancy", type: "prerequisite", weight: 0.9 },
      { id: "edge.phys.force_to_moment", from: "phys.force_basics", to: "phys.moment_of_force", type: "prerequisite", weight: 0.7 },
      { id: "edge.phys.energy_to_kinetic", from: "phys.energy_basics", to: "phys.kinetic_energy", type: "prerequisite", weight: 0.8 },
      { id: "edge.phys.energy_to_potential", from: "phys.energy_basics", to: "phys.potential_energy", type: "prerequisite", weight: 0.8 },
      { id: "edge.phys.kinetic_to_conservation", from: "phys.kinetic_energy", to: "phys.energy_conservation", type: "prerequisite", weight: 0.9 },
      { id: "edge.phys.potential_to_conservation", from: "phys.potential_energy", to: "phys.energy_conservation", type: "prerequisite", weight: 0.9 },
      { id: "edge.phys.energy_to_heat", from: "phys.energy_basics", to: "phys.heat_transfer", type: "supports", weight: 0.7 },
      { id: "edge.phys.light_to_reflection", from: "phys.light_basics", to: "phys.reflection_refraction", type: "prerequisite", weight: 0.8 },
      { id: "edge.phys.light_to_spectrum", from: "phys.light_basics", to: "phys.light_spectrum", type: "prerequisite", weight: 0.7 },
      { id: "edge.phys.reflection_to_spectrum", from: "phys.reflection_refraction", to: "phys.light_spectrum", type: "supports", weight: 0.6 },
      { id: "edge.phys.sound_to_wave", from: "phys.sound_basics", to: "phys.sound_wave", type: "prerequisite", weight: 0.9 },
      { id: "edge.phys.magnetic_to_force", from: "phys.magnetic_field_basics", to: "phys.magnetic_force", type: "prerequisite", weight: 0.8 },
      { id: "edge.phys.circuit_to_ohm", from: "phys.electric_circuit", to: "phys.resistance_ohm", type: "supports", weight: 0.9 },
      { id: "edge.phys.ohm_to_power", from: "phys.resistance_ohm", to: "phys.electric_power", type: "prerequisite", weight: 0.8 },
      { id: "edge.phys.circuit_to_power", from: "phys.electric_circuit", to: "phys.electric_power", type: "supports", weight: 0.7 },
      { id: "edge.phys.energy_to_nuclear", from: "phys.energy_basics", to: "phys.nuclear_energy_intro", type: "supports", weight: 0.5 },
      { id: "edge.phys.mass_to_buoyancy", from: "phys.mass_density", to: "phys.buoyancy", type: "supports", weight: 0.7 },
      // Physics objective assessment edges
      { id: "edge.obj.phys_grade6_foundation", from: "obj.phys.grade6.foundation", to: "phys.measure_with_tool", type: "assesses", weight: 0.8 },
      { id: "edge.obj.phys_grade7_foundation", from: "obj.phys.grade7.foundation", to: "phys.calculate_speed", type: "assesses", weight: 0.8 },
      { id: "edge.obj.phys_grade8_mechanics", from: "obj.phys.grade8.mechanics_energy", to: "phys.apply_energy_conservation", type: "assesses", weight: 0.8 },
      { id: "edge.obj.phys_grade9_electricity", from: "obj.phys.grade9.electricity_em", to: "phys.solve_ohm_law", type: "assesses", weight: 0.8 },
      // Physics misconception remediation edges
      { id: "edge.mis.phys.heavier_falls_faster_remediation", from: "mis.phys.heavier_falls_faster", to: "obj.phys.grade6.foundation", type: "remediates", weight: 0.9 },
      { id: "edge.mis.phys.force_needed_for_motion_remediation", from: "mis.phys.force_needed_for_motion", to: "obj.phys.grade6.foundation", type: "remediates", weight: 0.9 },
      { id: "edge.mis.phys.current_consumed_remediation", from: "mis.phys.current_consumed", to: "obj.phys.grade9.electricity_em", type: "remediates", weight: 0.9 },
      { id: "edge.mis.phys.heat_vs_temperature_remediation", from: "mis.phys.heat_vs_temperature", to: "obj.phys.grade8.mechanics_energy", type: "remediates", weight: 0.8 },
      { id: "edge.mis.phys.pressure_force_confusion_remediation", from: "mis.phys.pressure_force_confusion", to: "obj.phys.grade8.mechanics_energy", type: "remediates", weight: 0.8 },
      { id: "edge.mis.phys.unit_conversion_error_remediation", from: "mis.phys.unit_conversion_error", to: "obj.phys.grade6.foundation", type: "remediates", weight: 0.7 },
      { id: "edge.mis.phys.light_travels_only_straight_remediation", from: "mis.phys.light_travels_only_straight", to: "obj.phys.grade7.foundation", type: "remediates", weight: 0.8 },
      { id: "edge.mis.phys.sound_in_vacuum_remediation", from: "mis.phys.sound_in_vacuum", to: "obj.phys.grade6.foundation", type: "remediates", weight: 0.7 },
      { id: "edge.mis.phys.energy_disappears_remediation", from: "mis.phys.energy_disappears", to: "obj.phys.grade8.mechanics_energy", type: "remediates", weight: 0.9 },
      { id: "edge.mis.phys.density_vs_weight_remediation", from: "mis.phys.density_vs_weight", to: "obj.phys.grade6.foundation", type: "remediates", weight: 0.8 },
      { id: "edge.mis.phys.speed_velocity_confusion_remediation", from: "mis.phys.speed_velocity_confusion", to: "obj.phys.grade7.foundation", type: "remediates", weight: 0.7 },
      { id: "edge.mis.phys.buoyancy_depends_depth_remediation", from: "mis.phys.buoyancy_depends_depth", to: "obj.phys.grade8.mechanics_energy", type: "remediates", weight: 0.8 },
    ],
    programMaps: [
      {
      ...
      {
        programId: "vn_physics_6_7",
        domainIds: ["physics"],
        conceptIds: [
          "phys.measurement", "phys.mass_density", "phys.force_basics", "phys.motion_basics",
          "phys.energy_basics", "phys.light_basics", "phys.sound_basics",
          "phys.speed_graph", "phys.reflection_refraction", "phys.sound_wave",
          "phys.magnetic_field_basics", "phys.earth_solar_system",
        ],
        skillIds: [
          "phys.measure_with_tool", "phys.estimate_measurement", "phys.calculate_density",
          "phys.identify_force_effect", "phys.draw_force_diagram", "phys.describe_motion",
          "phys.identify_energy_form", "phys.explain_light_phenomenon", "phys.explain_sound_phenomenon",
          "phys.calculate_speed", "phys.read_motion_graph", "phys.explain_reflection",
          "phys.analyze_sound_wave", "phys.use_magnetic_compass", "phys.describe_solar_system",
        ],
        objectiveIds: ["obj.phys.grade6.foundation", "obj.phys.grade7.foundation"],
        entryObjectiveIds: ["obj.phys.grade6.foundation"],
      },
      {
        programId: "vn_physics_8_9",
        domainIds: ["physics"],
        conceptIds: [
          "phys.pressure", "phys.liquid_pressure", "phys.buoyancy", "phys.moment_of_force",
          "phys.kinetic_energy", "phys.potential_energy", "phys.energy_conservation", "phys.heat_transfer",
          "phys.resistance_ohm", "phys.electric_circuit", "phys.electric_power",
          "phys.magnetic_force", "phys.light_spectrum", "phys.nuclear_energy_intro",
        ],
        skillIds: [
          "phys.calculate_pressure", "phys.apply_liquid_pressure", "phys.apply_archimedes",
          "phys.calculate_moment", "phys.apply_energy_conservation", "phys.explain_heat_transfer",
          "phys.solve_ohm_law", "phys.analyze_circuit", "phys.calculate_electric_power",
          "phys.explain_em_induction", "phys.explain_light_spectrum", "phys.describe_nuclear_energy",
        ],
        objectiveIds: ["obj.phys.grade8.mechanics_energy", "obj.phys.grade9.electricity_em"],
        entryObjectiveIds: ["obj.phys.grade8.mechanics_energy"],
      },
    ],
  };

  extendVietnameseMathThcsTaxonomy(graph);
  extendVietnameseMathHighSchoolTaxonomy(graph);
...
function extendVietnameseMathThcsTaxonomy(graph: KnowledgeGraph): void {
  ...
  upsertById(graph.concepts, [
    ...
    { id: "math.diophantine_equation", domainId: "mathematics", name: "Diophantine equations", gradeBand: "8-9", tags: ["grade8", "number", "advanced"], status: "active" },
    { id: "math.advanced_geometry_theorems", domainId: "mathematics", name: "Advanced geometry theorems", gradeBand: "8-9", tags: ["grade8", "geometry", "advanced"], status: "active" },
    { id: "math.algebraic_extrema", domainId: "mathematics", name: "Algebraic extrema and inequalities", gradeBand: "8-10", tags: ["grade8", "algebra", "advanced"], status: "active" },
  ]);
  ...
  upsertById(graph.skills, [
    ...
    { id: "math.solve_diophantine_equation", domainId: "mathematics", name: "Solve Diophantine equations", conceptIds: ["math.diophantine_equation"], tags: ["grade8", "advanced"], status: "active" },
    { id: "math.apply_advanced_geometry_theorems", domainId: "mathematics", name: "Apply Menelaus, Ceva, and Van Aubel theorems", conceptIds: ["math.advanced_geometry_theorems"], tags: ["grade8", "advanced"], status: "active" },
    { id: "math.solve_algebraic_extrema", domainId: "mathematics", name: "Solve algebraic extrema problems", conceptIds: ["math.algebraic_extrema"], tags: ["grade8", "advanced"], status: "active" },
  ]);
  ...
  upsertById(graph.objectives, [
    ...
    },
    {
      ...
      conceptIds: [
        ...
        "math.diophantine_equation",
        "math.advanced_geometry_theorems",
        "math.algebraic_extrema"
      ],
      skillIds: [
        "math.factor_polynomial",
        "math.factor_common_terms",
        ...
        "math.solve_diophantine_equation",
        "math.apply_advanced_geometry_theorems",
        "math.solve_algebraic_extrema"
      ],
      status: "active",
    },
    {
  ...
  upsertById(graph.lessonTemplates, [
    ...
    {
      id: "math.thcs.grade8.geometry_similarity",
      domainId: "mathematics",
      title: "Grade 8 Geometry and Similarity",
      conceptIds: ["math.triangle_quadrilateral_geometry", "math.similarity_thales", "math.advanced_geometry_theorems"],
      skillIds: ["math.reason_triangle_quadrilateral", "math.apply_similarity_thales", "math.apply_advanced_geometry_theorems"],
      prerequisiteIds: ["math.triangle_geometry", "math.basic_geometry"],
      remediationObjectiveIds: ["obj.math.grade8.core", "obj.math.grade6_8.geometry_foundation"],
      stageIds: ["diagnostic", "concept_summary", "worked_example", "guided_steps", "independent_set", "mixed_review"],
      estimatedMinutes: 35,
      masteryTarget: 82,
      tags: ["math8", "geometry", "thcs"],
      status: "active",
    },
    {
  ...
  upsertById(graph.edges, [
    ...
    { id: "edge.math.factorization_to_diophantine", from: "math.factorization", to: "math.diophantine_equation", type: "prerequisite", weight: 0.8 },
    { id: "edge.math.inequality_to_extrema", from: "math.inequality", to: "math.algebraic_extrema", type: "prerequisite", weight: 0.8 },
    { id: "edge.math.similarity_to_advanced_theorems", from: "math.similarity_thales", to: "math.advanced_geometry_theorems", type: "prerequisite", weight: 0.8 },
...
function extendVietnameseMathHighSchoolTaxonomy(graph: KnowledgeGraph): void {
  upsertById(graph.concepts, [
    { id: "math.logic_sets", domainId: "mathematics", name: "Mathematical Logic and Sets", gradeBand: "10", status: "active" },
    { id: "math.linear_inequality_two_variables", domainId: "mathematics", name: "Linear Inequality in Two Variables", gradeBand: "10", status: "active" },
  ]);

  upsertById(graph.skills, [
    { id: "math10.logic.identify", domainId: "mathematics", name: "Nhận biết và phủ định mệnh đề", conceptIds: ["math.logic_sets"], status: "active" },
    { id: "math10.logic.implication", domainId: "mathematics", name: "Xét tính đúng/sai của mệnh đề kéo theo/tương đương", conceptIds: ["math.logic_sets"], status: "active" },
    { id: "math10.set.operation", domainId: "mathematics", name: "Thực hiện phép toán trên các tập hợp số", conceptIds: ["math.logic_sets"], status: "active" },
    { id: "math10.set.word_problems", domainId: "mathematics", name: "Giải bài toán ứng dụng thực tế về tập hợp", conceptIds: ["math.logic_sets"], status: "active" },
    { id: "math10.error.approximation", domainId: "mathematics", name: "Tính toán sai số và số gần đúng", conceptIds: ["math.logic_sets"], status: "active" },
    { id: "math10.ineq2.single", domainId: "mathematics", name: "Biểu diễn miền nghiệm của bất phương trình bậc nhất hai ẩn", conceptIds: ["math.linear_inequality_two_variables"], status: "active" },
    { id: "math10.ineq2.system", domainId: "mathematics", name: "Biểu diễn miền nghiệm của hệ bất phương trình", conceptIds: ["math.linear_inequality_two_variables"], status: "active" },
    { id: "math10.ineq2.optimization", domainId: "mathematics", name: "Giải bài toán tối ưu hóa thực tế", conceptIds: ["math.linear_inequality_two_variables"], status: "active" },
    { id: "math10.func.general", domainId: "mathematics", name: "Tìm tập xác định và khảo sát tính đơn điệu hàm số", conceptIds: ["math.functions_graphs"], status: "active" },
    { id: "math10.func.quadratic_graph", domainId: "mathematics", name: "Khảo sát và vẽ parabol bậc hai", conceptIds: ["math.quadratic_equation"], status: "active" },
    { id: "math10.func.quadratic_app", domainId: "mathematics", name: "Ứng dụng hàm số bậc hai vào thực tế", conceptIds: ["math.quadratic_equation"], status: "active" },
    { id: "math10.ineq.quadratic", domainId: "mathematics", name: "Giải bất phương trình bậc hai và xét dấu tam thức", conceptIds: ["math.quadratic_equation"], status: "active" },
    { id: "math10.eq.irrational", domainId: "mathematics", name: "Giải phương trình chứa căn thức quy về bậc hai", conceptIds: ["math.quadratic_equation"], status: "active" },
    { id: "math10.trig.identity", domainId: "mathematics", name: "Tính giá trị lượng giác của một góc từ 0 đến 180 độ", conceptIds: ["math.trigonometry"], status: "active" },
    { id: "math10.trig.triangle_laws", domainId: "mathematics", name: "Áp dụng định lý côsin và định lý sin giải tam giác", conceptIds: ["math.trigonometry"], status: "active" },
    { id: "math10.trig.area_formulas", domainId: "mathematics", name: "Tính diện tích tam giác và bán kính ngoại/nội tiếp", conceptIds: ["math.trigonometry"], status: "active" },
    { id: "math10.trig.practical", domainId: "mathematics", name: "Bài toán ứng dụng lượng giác thực tế", conceptIds: ["math.trigonometry"], status: "active" },
    { id: "math10.vector.definition", domainId: "mathematics", name: "Nhận biết vectơ cùng phương, cùng hướng, bằng nhau", conceptIds: ["math.vector_coordinate_geometry"], status: "active" },
    { id: "math10.vector.addition", domainId: "mathematics", name: "Thực hiện phép cộng và trừ vectơ", conceptIds: ["math.vector_coordinate_geometry"], status: "active" },
    { id: "math10.vector.scalar_mult", domainId: "mathematics", name: "Thực hiện tích của vectơ với một số", conceptIds: ["math.vector_coordinate_geometry"], status: "active" },
    { id: "math10.vector.dot_product", domainId: "mathematics", name: "Tính tích vô hướng của hai vectơ", conceptIds: ["math.vector_coordinate_geometry"], status: "active" },
    { id: "math10.oxy.vector", domainId: "mathematics", name: "Tìm tọa độ điểm và tọa độ vectơ", conceptIds: ["math.vector_coordinate_geometry"], status: "active" },
    { id: "math10.oxy.line", domainId: "mathematics", name: "Viết phương trình đường thẳng", conceptIds: ["math.vector_coordinate_geometry"], status: "active" },
    { id: "math10.oxy.distance", domainId: "mathematics", name: "Tính khoảng cách và góc", conceptIds: ["math.vector_coordinate_geometry"], status: "active" },
    { id: "math10.oxy.circle", domainId: "mathematics", name: "Viết phương trình đường tròn", conceptIds: ["math.vector_coordinate_geometry"], status: "active" },
    { id: "math10.oxy.conic", domainId: "mathematics", name: "Xác định đặc tính và viết phương trình đường Conic", conceptIds: ["math.vector_coordinate_geometry"], status: "active" },
    { id: "math10.comb.rules", domainId: "mathematics", name: "Áp dụng quy tắc cộng và quy tắc nhân", conceptIds: ["math.combinatorics_probability"], status: "active" },
    { id: "math10.comb.permutations", domainId: "mathematics", name: "Tính hoán vị, chỉnh hợp, tổ hợp", conceptIds: ["math.combinatorics_probability"], status: "active" },
    { id: "math10.comb.newton", domainId: "mathematics", name: "Khai triển nhị thức Newton", conceptIds: ["math.combinatorics_probability"], status: "active" },
    { id: "math10.stats.central", domainId: "mathematics", name: "Tính các số đặc trưng đo xu thế trung tâm", conceptIds: ["math.statistics_advanced"], status: "active" },
    { id: "math10.stats.dispersion", domainId: "mathematics", name: "Tính số đặc trưng đo độ phân tán", conceptIds: ["math.statistics_advanced"], status: "active" },
    { id: "math10.prob.classical", domainId: "mathematics", name: "Tính xác suất cổ điển", conceptIds: ["math.probability"], status: "active" },
  ]);
  ...
  mergeProgramMap(graph, {
    ...
    conceptIds: [
      "math.logic_sets",
      "math.linear_inequality_two_variables",
    ],
    skillIds: [
