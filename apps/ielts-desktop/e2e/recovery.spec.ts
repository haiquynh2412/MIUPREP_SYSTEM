...
test.describe('IELTS Session Autosave & Recovery E2E Flow', () => {
  ...
  test('Should resume an in-progress session successfully preserving state', async ({ page }) => {
    ...
    // 2. Start Reading Test in Practice Mode
    ...
    // 6. Click "Resume Active Session" and verify it khôi phục answers
    ...
    await expect(restoredInput).toHaveValue('wood');
