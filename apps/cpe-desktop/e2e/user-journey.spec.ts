...
test.describe('CPE Preparation App E2E User Journey', () => {
  ...
  test('Should navigate the complete user journey: Dashboard -> Reading Exam -> Pause/Resume -> Submit -> Review -> Writing AI -> Speaking AI -> Error Notebook', async ({
    ...
    await page.keyboard.insertText(
      'The proliferation of artificial intelligence in modern educational paradigms has engendered significant discourse regarding its pedagogical implications for C2-level learners.',
    );
