            ...
            <>
              <div className="text-right">
                ...
                <span className="text-sm font-bold text-slate-700">
                  Raw Score: <span className="text-emerald-600 font-mono">{reviewAttempt?.scores?.rawScore ?? 0}/{reviewAttempt?.scores?.totalQuestions ?? 0}</span> | 
                  Band: <span className="text-emerald-600 font-mono font-black">{reviewAttempt?.scores?.bandScore?.toFixed(1) ?? '0.0'}</span>
