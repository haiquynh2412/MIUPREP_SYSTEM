        ...
        <header className="bg-gradient-to-r from-emerald-700 to-emerald-800 text-white px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div className="text-left">
              ...
              <span className="text-[10px] text-emerald-200 font-semibold tracking-wide uppercase mt-0.5 block">{selectedTestForMode.title}</span>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div 
              ...
              className="border border-slate-200 hover:border-emerald-400 bg-slate-50/50 hover:bg-emerald-50/10 p-5 rounded-xl cursor-pointer transition-all flex flex-col gap-2.5 hover:shadow-md group text-left"
            >
              ...
              <h4 className="text-sm font-bold text-slate-800 m-0 group-hover:text-emerald-700">Practice Mode</h4>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-[9px] bg-red-100 text-red-700 font-bold px-2 py-0.5 rounded border border-red-200 uppercase">Thi thật</span>
              </div>
