export default function MiuMathAdminDashboard({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', fontFamily: 'system-ui, sans-serif' }}>
      ...
      >
        <div
          style={{ background: 'rgba(255, 255, 255, 0.15)', padding: '20px', borderRadius: '50%', fontSize: '3rem' }}
        >
          👑
        </div>
        <div>
          ...
          <p style={{ color: '#ccfbf1', fontSize: '0.98rem', marginTop: '6px', fontWeight: 500 }}>
            Chào mừng bạn quay lại Hệ thống quản trị trung tâm MiuMath. Hôm nay chúng ta sẽ bổ sung chuyên đề hay cấp
            quyền cho thành viên nào đây meow? 🐾💻
          </p>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
        ...
        >
          ...
          <div>
            ...
            <h3 style={{ fontSize: '1.8rem', color: '#0f766e', fontWeight: 800, margin: '2px 0 0' }}>
        ...
        >
          ...
          <div>
            ...
            <h3 style={{ fontSize: '1.8rem', color: '#047857', fontWeight: 800, margin: '2px 0 0' }}>
          ...
          {CHUYEN_DE_LIST.map((cd) => {
            ...
            return (
              <div key={cd.id} style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                ...
                >
                  <div
                    style={{ width: `${percent}%`, height: '100%', background: '#10b981', borderRadius: '4px' }}
                  ></div>
                </div>
              </div>
            );
