const DIARY_MOODS = ['😸 Hạnh phúc', '😿 Lo lắng', '😾 Mệt mỏi', '😼 Quyết tâm', '💤 Lười meow'];
...
export default function MathDiaryRoom({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div
        className="card"
        style={{ background: 'var(--color-primary-soft)', border: '1px solid rgba(16, 185, 129, 0.2)' }}
      >
        ...
        {diaryEntries.length > 0 ? (
          diaryEntries.map((entry) => (
            ...
            >
              ...
              <p style={{ fontSize: '0.95rem', color: '#064e3b', whiteSpace: 'pre-wrap', lineHeight: 1.5 }}>
                {entry.content}
              </p>
              <button
                style={{
