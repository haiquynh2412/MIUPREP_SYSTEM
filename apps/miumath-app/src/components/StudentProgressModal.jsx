        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', fontSize: '0.88rem' }}>
            <div style={{ flex: 1, border: '1.5px solid #fee2e2', padding: '10px 14px', borderRadius: '12px', textAlign: 'center' }}>
              ...
              <h5 style={{ margin: '4px 0 0', fontSize: '1.2rem', color: '#ef4444', fontWeight: 800 }}>{traps.length} cau</h5>
            </div>
            <div style={{ flex: 1, border: '1.5px solid #d1fae5', padding: '10px 14px', borderRadius: '12px', textAlign: 'center' }}>
              ...
              <h5 style={{ margin: '4px 0 0', fontSize: '1.2rem', color: '#10b981', fontWeight: 800 }}>{bookmarks.length} cau</h5>
            </div>
          </div>
              ...
              {diaries.length > 0 ? (
                diaries.map((diary) => (
                  <div key={diary.id} style={{ background: '#f9fdfb', border: '1px solid #e6f7f0', borderLeft: '4px solid #10b981', padding: '10px 12px', borderRadius: '8px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.75rem', fontWeight: 700, color: '#15803d' }}>
                ...
                <p style={{ margin: 0, fontSize: '0.85rem', color: '#666', fontStyle: 'italic', padding: '10px 0' }}>Hoc sinh nay chua viet trang nhat ky hoc tap nao.</p>
              )}
            </div>
          </div>
        </div>
