param(
  ...
  [string]$OutPath = "reports\content-quality\math9-rich-raw-extract.json",
  [string]$HtmlWorkDir = "reports\content-quality\math9-rich-html",
...
function Write-ExtractPayload {
  ...
  $payload = [ordered]@{
    schemaVersion = "math9_rich_raw_extract_v1"
