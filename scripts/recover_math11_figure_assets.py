...
RAW_PATH = os.path.join(REPORT_DIR, "math11-rich-raw-extract.json")
EXCLUDED_PATH = os.path.join(REPORT_DIR, "math11-excluded-question-bank.json")
GUARD_PATH = os.path.join(REPORT_DIR, "math11-content-guard.json")
ASSET_DISK_ROOT = os.path.join(WORKSPACE_ROOT, "apps", "miuprep-portal", "public", "assets", "math11", "figures")
ASSET_PUBLIC_ROOT = "/assets/math11/figures"
REPORT_PATH = os.path.join(REPORT_DIR, "math11-figure-recovery-report.json")
REPAIR_CODES = {
...
def persist_progress(raw_payload, targets_count: int, recovered: list[dict], skipped: list[dict]) -> None:
    ...
    write_json(REPORT_PATH, {
        "schemaVersion": "math11_figure_recovery_report_v1",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Recover Math 11 figure assets by cropping source PDF question blocks.")
